...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        [TestMethod]
        public void CanSetSummaryViewModel()
        {
            //Setup
            IRepository<Basket> baskets = new MockContext<Basket>();
            IRepository<Product> products = new MockContext<Product>();
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "Somecustomer@email.com", ZipCode = "12345" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("Somecustomer@email.com", "Forms"), null);
